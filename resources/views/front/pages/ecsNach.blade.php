            ...
            <div class="row" style="border:2px solid #296dc1;">
                ...
                <div class="col-md-12">
                    ...
                    <div class="contact-wrap form-style">
                        ...
                        <br /><br />
                        <form method="post" id="form-data" enctype='multipart/form-data' action="{{ url('ecs-nach-cancelsave') }}">
                          @csrf
                            <div class="row">
                                ...
                                <div class="form-group  col-sm-6 col-xs-12">
                                    <input type="text" name="mobile_no" readonly pattern="[6789][0-9]{9}" minlength="10" maxlength="10" placeholder="Mobile Number" id="mob_No_"  />
                                </div>
                                <div class="form-group col-sm-6 col-xs-12">
                                ...
                                <div class="form-group col-sm-6 col-xs-12">
                                    <input type="text" name="branch_name"  id="branch_code" readonly placeholder="Branch Name " />
                                </div>
                                ...
                                <div class="form-group  col-xs-4">
                                    ...
                                    <input type="text" name="date" readonly value="<?php date_default_timezone_set('Asia/Kolkata');
echo date('d-m-Y H:i'); ?>"  id="input_date">
                                </div>
                                <!--end date & sign-->
                                ...
                                <div class="form-group col-xs-12 pull-center text-center">
                                    <button type="submit"  class="btn btn-primary btn-responsive" style="width:150px; height:50px;" class="cont-submit btn-contact btn-primary pull-center" onclick='printDiv();'>Submit</button>
                                </div>
                            </div>
                        </form>
                    </div>
