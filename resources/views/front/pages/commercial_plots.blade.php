...
@section('title', 'Commercial Plots')
...
<div class="breadcumb-area black-opacity bg-img-18">
    <div class="container">
        <div class="row">
            <div class="col-xs-12">
        ...
        <div class="container-fluid" style="margin-bottom:-50px;">
            <div class="row" style="margin:5px 0px;">
                <div class="col-md-7" style="background-color:#296DC1;">
                    <br>
                    <h3 style="color:white; text-align:center;"><b>Commercial Plots</b></h3>
                    <table class="table table-bordered" style="background-color:white;">
                        ...
                        <tbody>
                            <tr>
                                <td><b>Purpose</b></td>
                                <td> For Purchase of Commercial Plots allotted by Govt. Authorities</td>
                            </tr>
                            ...
                            <tr>
                                <td><b>Margin(%)</b></td>
                                <!--<td> 20% to 40%</td>-->
                                <td><i class="fa fa-check-square-o" aria-hidden="true"></i> 20% to 40%<br>
                                    <!--<i class="fa fa-check-square-o" aria-hidden="true"></i> Rate Rs. 30 lakh to 75 lakh - 28%<br>-->
                                    <!-- <i class="fa fa-check-square-o" aria-hidden="true"></i>  Rate Above 30 lakh - 25%</td>-->
                            </tr>
                ...
                <div class="col-md-4 col" style="background-color:#296DC1;height:432px;">
