            ...
            <div class="row">
                <div class="col-xs-12">
                    <div class="breadcumb-wrap">
                        <h2>E-Nach Request Check Mobile No</h2>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <ul>
                            ...
                            <li>/</li>
                            <li>E-Nach Request Check Mobile No</li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <section class="about-area ptb-100">
            <div class="container">
                <div class="row" style="border:2px solid #296dc1;">
                    ...
                    <div class="col-md-12">
                        <br />
                        <h3 style='color:#296dc1;' class="text-center pull-center"><b>E-Nach Request Check Mobile No</b></h3>
                            ...
                            <div class="login-wrap p-4 p-lg-5">
                                 ...
                                 <div id="otpverifydiv">
                                    <form method="post" id="form-data" enctype='multipart/form-data'
                                        action="{{ url('Enach-Request-CheckMobverify') }}" >
                                        @csrf
                                            ...
                                            <div class="col-lg-4">
                                                <div class="form-group  ">
                                                    <input type="number" name="mobile_no" minlength="10" maxlength="10"
                                                        placeholder="Enter 10 digit mobile No" value="7550404066"  required/>
                                                </div>
                                            </div>
