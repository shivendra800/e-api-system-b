...
<div class="breadcumb-area black-opacity bg-img-20">
    <div class="container">
        <div class="row">
            <div class="col-xs-12">
                <div class="breadcumb-wrap">

                    <h2>Low Income Group Program<p style="color:white;font-size:12pt;"></p>
                    </h2>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-xs-12">
                    <ul>
                        ...
                        <li>/</li>
                        <li>Low Income Group Program</li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="container-fluid" style="margin-bottom:-50px;">
            <div class="row" style="margin:5px 0px;">
                <div class="col-md-8" style="background-color:#296DC1;">
                    <br>
                    <h3 style="color:white; text-align:center;"><b>Low Income Group Program</b></h3>
                    <table class="table table-bordered" style="background-color:white;">
                        ...
                        <tbody>
                            <tr>
                                <td><b>Purpose</b></td>
                                <td> For Purchase/Construction/ Improvement/Extension/Plot purchase plus Construction/ Top Up -Housing</td>
                            </tr>

                            <tr>
                                <td><b>Eligibility</b></td>
                                <td> Individuals who are salaried/ self employed
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td> <i class="fa fa-check-square-o" aria-hidden="true"></i> Min : Rs. 2 Lakh <br>
                                    <i class="fa fa-check-square-o" aria-hidden="true"></i> Max : Rs. 15 Lakh </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <p><i class="fa fa-check"></i> Home Loan offered for Individuals who does not have adequate repayment capacity supported by proofs i.e. Salary Slips/Form 16/ and Income tax returns etc.</p>
                ...
                <div class="col-md-3 col-sm-2 col-xs-12 col" style="background-color:#296DC1;height:463px;">
