        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-12" style="background-color:#296dc1;">
                    <br>
                    <h3 style="color:white; text-align:center;"><b>Tender For Office Premises In Akurdi</b></h3>
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody style="background-color:#fff; color:#296dc1;">
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">Technical and Financial Bid for Office Premises at Akurdi </td>
                                    <th class="text-center">20/05/2023</th>
                                    <th class="text-center">05/06/2023</th>

                                    <td class="text-center">
                                        <a href="{{url('/')}}/front_assests/pdf/LIST OF LOCALITY.docx" title="LIST OF LOCALITY" style="color:#296dc1;"> <i class="fa fa-file-pdf-o" style="font-size:22px;color:#296dc1;"></i></a>
                                        <a href="{{url('/')}}/front_assests/pdf/Lease Agreement Standard Format - FINAL Copy.docx" title="Lease Agreement Standard Format - FINAL" style="color:#296dc1;"> <i class="fa fa-file-pdf-o" style="font-size:22px;color:#296dc1;"></i></a>
                                        <a href="{{url('/')}}/front_assests/pdf/Technical Bid.docx" title="Technical Bid" style="color:#296dc1;"> <i class="fa fa-file-pdf-o" style="font-size:22px;color:#296dc1;"></i></a>
                                        <a href="{{url('/')}}/front_assests/pdf/Financial Bid.docx" title="Financial Bid" style="color:#296dc1;"> <i class="fa fa-file-pdf-o" style="font-size:22px;color:#296dc1;"></i></a>
                                        <a href="{{url('/')}}/front_assests/pdf/Annexure 2-Consent Letter.docx" title="Annexure 2-Consent Letter" style="color:#296dc1;"> <i class="fa fa-file-pdf-o" style="font-size:22px;color:#296dc1;"></i></a>
