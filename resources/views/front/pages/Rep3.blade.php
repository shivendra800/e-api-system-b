        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-12" style="background-color:#296dc1;">
                    <br>
                    <h3 style="color:white; text-align:center;"><b>Tender For Office Premises In Jodhpur</b></h3>
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody style="background-color:#fff; color:#296dc1;">
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">Technical and Financial Bid for Office Premises at Jodhpur Location</td>
                                    <th class="text-center">22.08.2022</th>
                                    <th class="text-center">04.08.2022</th>

                                    <td class="text-center">
                                        <a href="{{url('/')}}/front_assests/pdf/Technical & Financial Bid Format -Jodhpur.pdf" style="color:#296dc1;"> <i class="fa fa-file-pdf-o" style="font-size:22px;color:#296dc1;"></i></a>
                                    </td>
                                </tr>
