...
// $headers .= "From: <'.$email.'>" . "\r\n" ;
    ...
    if($sql)
    {
        ...
        echo "<script>alert('Form Submitted Successfully');window.location.href='income_based.php';</script>";
         }
    }
    
else{
    echo "<script>alert('Try Again!');window.location.href='income_based.php';</script>";
}
}
...
<div class="breadcumb-area black-opacity bg-img-15">
    <div class="container">
        <div class="row">
            <div class="col-xs-12">
                <div class="breadcumb-wrap">

                    <h2>Income based Program<p style="color:white;font-size:12pt;"></p>
                    </h2>
                    <!--<br/><i>More Interest More Happiness</i>-->
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="container-fluid" style="margin-bottom:-50px;">
            ...
            <div class="row" style="margin:5px 0px;">
                <div class="col-md-8" style="background-color:#296DC1;">
                    <br>
                    <h3 style="color:white; text-align:center;"><b>Income based Program</b></h3>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td> Upto 30 Years (Subject to Maximum age of 65 years or Retirement age, whichever is
                                    earlier for Salaried and For Self Employed maximum age is 70 years at the time of loan maturity)</td>
                            </tr>
                ...
                <div class="col-md-3 col-sm-2 col-xs-12 col" style="background-color:#296DC1;height:451px;">
