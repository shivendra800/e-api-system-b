    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-md-12" style="background-color:#296dc1;">
          <br>
          <h3 style="color:white; text-align:center;"><b>RFP for IT solution</b></h3>
            ...
            <table class="table table-bordered">
              ...
              <tbody style="background-color:#fff; color:#296dc1;">
                ...
                <tr>
                  ...
                  <td class="text-center">corrigendum 3</td>


                  <td class="text-center">
                    <a href="{{url('/')}}/front_assests/pdf/CBHFL RFP Addendum 3 dated 29 April 2022.pdf" style="color:#296dc1;"> <i class="fa fa-file-pdf-o" style="font-size:22px;color:#296dc1;"></i></a>
                  </td>
                </tr>
